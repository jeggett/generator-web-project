...
module.exports = generators.Base.extend({
  prompting: function () {
    ...
    this.log(yosay(
      'Welcome to the stupendous ' + chalk.red('Web-project')
      + ' generator'
    ));
  ...
  writing: {
    fixed: function () {
      var fixedFilePaths = [
        '_package.json', 'main.js', 'colorScheme.less',
    ...
    flexible: function () {
      var flexibleFilePaths = [
        'index.jade', 'bower.json', 'main.less', 'gulpfile.js'
      ];
  ...
  install: function () {
    ...
    if (this.props.includeReact === true) {
      this.spawnCommand('npm', ['install', '--save-dev', 'react@0.14.8']);
    }
  }
});
